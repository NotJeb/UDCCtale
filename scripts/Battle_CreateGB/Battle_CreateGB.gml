function Battle_CreateGB(_start_x, _start_y, _start_angle, _end_x, _end_y, _end_angle, _move_time, _shoot_time, _xscale = 1, _yscale = 2) {
	...
	var _inst = instance_create_depth(_start_x, _start_y, DEPTH_BATTLE.BULLET_OUTSIDE_HIGH, battle_bullet_gb_head_skelly);
	...
	_inst.alarm[1] = _move_time + _shoot_time; // Try to delete instance
}