function Battle_Slam(_dir) {
	...
	else if (_dir == DIR.DOWN) battle_soul.move = abs((battle_board.x - battle_board.left - battle_soul.x) / 10);
	else if (_dir == DIR.LEFT) battle_soul.move = abs((battle_board.y + battle_board.down - battle_soul.y) / 10);
