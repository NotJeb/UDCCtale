function Battle_CreateBoneWall(_side, _length, _warn_time, _extend_time) {
	...
	switch (_side) {
		...
		case DIR.LEFT:
			...
			break;
		case DIR.RIGHT:
			if (_warn_time > 0) Battle_CreateWarning(bb._frame_right_x - _length + 1, bb._frame_up_y + bb._frame_up_height + 1, bb._frame_right_x - 1, bb._frame_down_y - 1 + 10, _warn_time, snd_bonestab);
			for (var i = 0; i < bb.down + bb.up + 12; i += 12) {
