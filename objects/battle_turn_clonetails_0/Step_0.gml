...
if (time == 310) {
	...
	var _event_0 = function(_gb0, _gb1, _gb2, _gb3) {
		...
		Anim_Create(_gb0, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb0.image_angle, 0 - _gb0.image_angle, 5);
		
		Anim_Create(_gb1, "x", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb1.x, bb.x - _gb1.x, 5);
		Anim_Create(_gb1, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb1.image_angle, 90 - _gb1.image_angle, 5);
		
		Anim_Create(_gb2, "y", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb2.y, bb.y - _gb2.y, 5);
		Anim_Create(_gb2, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb2.image_angle, 180 - _gb2.image_angle, 5);
		
		Anim_Create(_gb3, "x", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb3.x, bb.x - _gb3.x, 5);
		Anim_Create(_gb3, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb3.image_angle, 270 - _gb3.image_angle, 5);
	}
...
if (time == 341) {
	...
	var _event_0 = function(_gb0, _gb1, _gb2, _gb3) {
		...
		Anim_Create(_gb0, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb0.image_angle, 45 - _gb0.image_angle, 5);
		
		Anim_Create(_gb1, "x", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb1.x, bb.x + 100 - _gb1.x, 5);
		Anim_Create(_gb1, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb1.image_angle, 135 - _gb1.image_angle, 5);
		
		Anim_Create(_gb2, "y", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb2.y, bb.y - 100 - _gb2.y, 5);
		Anim_Create(_gb2, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb2.image_angle, 225 - _gb2.image_angle, 5);
		
		Anim_Create(_gb3, "x", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb3.x, bb.x - 100 - _gb3.x, 5);
		Anim_Create(_gb3, "image_angle", ANIM_TWEEN.SINE, ANIM_EASE.IN_OUT, _gb3.image_angle, 315 - _gb3.image_angle, 5);
	}
	Delay_Event(_event_0, 30, [_gb0, _gb1, _gb2, _gb3]);
}
if (time == 372) {
