...
if (Battle_Repeat(110, 350, 3)) {
	...
	var _bone0 = Battle_CreateBone(bb.x + 340, bb.y - 55, 41 + _length, 180, 0, 80);
	Anim_Create(_bone0, "x", 0, 0, bb.x + 340, -660, 80);
	
	var _bone1 = Battle_CreateBone(bb.x + 340, bb.y + 55, 41 - _length, 0, 0, 80);
	Anim_Create(_bone1, "x", 0, 0, bb.x + 340, -660, 80);
}
if (Battle_Repeat(380, 620, 20)) {
	for (var i = 0; i < 4; i++) {
		var _side = (time - 380) % 40 == 0;
		var _bone0 = Battle_CreateBone(bb.x + 340 + i * 12, bb.y + (_side ? -55 : 55), 0, (_side ? 180 : 0), 0, 80);
		Anim_Create(_bone0, "x", 0, 0, bb.x + 340 + i * 12, -718, 80);
		Anim_Create(_bone0, "length", ANIM_TWEEN.SINE, ANIM_EASE.OUT, 30, 32, 8, i * 2);
	}
}
if (Battle_Repeat(620, 647, 3)) {
	var _length = ((time - 620) / 3) * 5;
	
	var _bone0 = Battle_CreateBone(bb.x + 340, bb.y - 55, _length, 180, 0, 80);
	Anim_Create(_bone0, "x", 0, 0, bb.x + 340, -660, 80);
	
	var _bone1 = Battle_CreateBone(bb.x + 340, bb.y + 55, _length, 0, 0, 80);
	Anim_Create(_bone1, "x", 0, 0, bb.x + 340, -660, 80);
}
if (time == 690) {
