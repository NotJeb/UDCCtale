...
if (Battle_Repeat(0, 260, 5)) {
	var _x_start = bb.x + cos(time * (pi / 46)) * 450;
	var _y_start = bb.y + sin(time * (pi / 46)) * 450;
	var _x_end = bb.x + cos(time * (pi / 46)) * 100;
	var _y_end = bb.y + sin(time * (pi / 46)) * 100;
