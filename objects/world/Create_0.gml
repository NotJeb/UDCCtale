...
enemy = {
	...
	title : [ENEMY_TITLE_SKELLY, ENEMY_TITLE_DLECKON, ENEMY_TITLE_KACPII, ENEMY_TITLE_CLONETAILS, ENEMY_TITLE_CANDLE_AND_MOSS, ENEMY_TITLE_SHAUN_AND_MINUS, ENEMY_TITLE_SHAUN_AND_MINUS],
	...
	name : [ENEMY_NAME_SKELLY, ENEMY_NAME_DLECKON, ENEMY_NAME_KACPII, ENEMY_NAME_CLONETAILS, ENEMY_NAME_CANDLE_AND_MOSS, ENEMY_NAME_SHAUN_AND_MINUS, ENEMY_NAME_SHAUN_AND_MINUS],
};
